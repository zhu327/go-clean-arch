...
Use plain, concise language and established kfinops terminology. Apply [LANGUAGE.md](LANGUAGE.md) concepts when they make the architectural point more precise; do not rename accurate terms such as domain, usecase, handler, repository, gateway, API, or layer merely to match the glossary.

**Wins bullets** should name a concrete gain, preferably locality, leverage, interface size, test surface, or removed coupling. Avoid unsupported claims such as merely "cleaner code."
