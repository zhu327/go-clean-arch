...
- **Injection**: SQL injection via string concatenation (use GORM parameterized queries)
...
- **Command injection**: User input passed to `exec.Command` without sanitization
...
// Dangerous: Check-then-act without transaction
