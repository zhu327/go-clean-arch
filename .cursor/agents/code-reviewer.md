...
Use `code-review-expert`'s findings format for the body of your review (P0–P3 with **Symptom → Consequence → Remedy**, plus "Structural Simplification Opportunities" and "Removal/Iteration Plan" sections). Then wrap it with these subagent-specific sections:
